...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        },{id: "post-opdc-홈페이지-개설-취지-및-앞으로의-각오",
    ...
    },{id: "post-2025-표준프레임워크-컨트리뷰터가-되는-lt-4주-완성-집중코스-gt",
      
        title: "2025 표준프레임워크 컨트리뷰터가 되는 &lt;4주 완성 집중코스&gt;",
      
      description: "2025/07/16(목) 19:00",
      section: "Posts",
      handler: () => {
        
          window.location.href = "/blog/2025/seminar-contribution/";
          ...
          description: "OPA Leader",
          section: "Leaders",handler: () => {
              window.location.href = "/leaders/35-kim-hoejung/";
            },},{id: "news-준비-중",
          title: '준비 중',
          description: "",
